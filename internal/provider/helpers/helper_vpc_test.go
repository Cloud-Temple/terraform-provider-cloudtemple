...
//
// keysOf, assertKeySet and assertEq are shared test helpers defined in
// helper_compute_iaas_opensource_network_adapter_test.go and
// helper_compute_iaas_opensource_pool_test.go (same package).
