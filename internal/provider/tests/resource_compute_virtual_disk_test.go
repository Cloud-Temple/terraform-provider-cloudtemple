		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cloudtemple_compute_virtual_disk.foo", "datastore_id", os.Getenv(DataStoreId)),
					resource.TestCheckResourceAttr("cloudtemple_compute_virtual_disk.foo", "name", os.Getenv(VirtualDiskName)),
					resource.TestCheckResourceAttr("cloudtemple_compute_virtual_disk.foo", "machine_manager_id", os.Getenv(MachineManagerId)),
					...
					resource.TestCheckResourceAttr("cloudtemple_compute_virtual_disk.foo", "datastore_name", os.Getenv(DataStoreName)),
